  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-12 pb-24 lg:pb-12 space-y-10">
        ...
        <div className="bg-white p-5 sm:p-10 rounded-3xl border border-stone-200 shadow-2xs space-y-6 text-xs sm:text-sm text-stone-700 leading-relaxed">
          <p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-4">
            <div className="p-4 bg-red-50/40 rounded-2xl border border-red-200">
              <h4 className="font-bold text-stone-900 text-sm">Net Fiyat Garantisi</h4>
          ...
          <div className="pt-4 border-t border-stone-200 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <Link
              ...
              className="px-6 py-3 bg-[#e60012] hover:bg-[#c90010] text-white font-bold text-xs rounded-xl shadow-md transition inline-flex items-center gap-2"
            >
