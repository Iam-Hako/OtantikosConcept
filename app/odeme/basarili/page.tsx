...
function OrderSuccessContent() {
  ...
  useEffect(() => {
    if (orderNumber && !orderNumber.startsWith('sim-')) {
      try {
        confetti({
          particleCount: 80,
          spread: 70,
    ...
    return (
      <div className="bg-white min-h-screen flex items-center justify-center">
        <div className="max-w-xl mx-auto px-4 py-16 text-center space-y-6">
          <div className="w-16 h-16 bg-red-50 text-[#e60012] border border-red-200 rounded-3xl flex items-center justify-center mx-auto shadow-xs">
            <Package className="w-8 h-8" />
          </div>
          <div className="space-y-2">
            <span className="text-xs font-bold uppercase tracking-widest text-[#e60012] bg-red-50 px-3 py-1 rounded-full border border-red-200">
              Altyapı Hazırlığı Devam Ediyor
            </span>
            ...
            <p className="text-xs sm:text-sm text-stone-600 max-w-md mx-auto leading-relaxed">
              iyzico Sanal POS entegrasyonumuz tamamlanma aşamasındadır. Kredi kartı ile doğrudan sipariş alımlarımız çok yakında başlayacaktır.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Link
              href="/yakinda"
              className="w-full sm:w-auto px-6 py-3 bg-[#e60012] hover:bg-[#c90010] text-white text-xs font-bold rounded-xl shadow-md transition flex items-center justify-center gap-2"
            >
              <span>Açılış Bilgilendirmesini Gör</span>
              <ArrowRight className="w-4 h-4" />
            </Link>
            <a
              href={`https://wa.me/905077737777?text=${encodeURIComponent('Merhaba, ürünleriniz hakkında bilgi ve sipariş vermek istiyorum.')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl shadow-md transition flex items-center justify-center gap-2"
            >
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-4 py-16 text-center space-y-8">
        ...
        <div className="p-6 bg-stone-50 rounded-3xl border border-stone-200 shadow-sm max-w-md mx-auto space-y-3">
          <div className="text-xs text-stone-500 font-medium">Sipariş Takip Numaranız:</div>
          <div className="text-2xl font-mono font-black text-[#e60012] tracking-wider select-all">
            {orderNumber}
          </div>
        ...
        <div className="bg-stone-50/50 p-6 sm:p-8 rounded-3xl border border-stone-200 shadow-sm text-left space-y-6">
          ...
          <div className="grid grid-cols-4 gap-2 text-center text-xs">
            ...
            <div className="space-y-2">
              <div className="w-8 h-8 rounded-full bg-[#e60012] text-white font-bold mx-auto flex items-center justify-center animate-pulse">
                2
              </div>
              <div className="font-bold text-stone-900 text-[11px]">Hazırlanıyor</div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <Link
            ...
            className="w-full sm:w-auto px-6 py-3.5 bg-[#e60012] hover:bg-[#c90010] text-white text-xs font-bold rounded-xl shadow-md transition flex items-center justify-center gap-2"
          >
