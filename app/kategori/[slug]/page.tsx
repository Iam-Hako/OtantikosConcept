      ...
      <div className="w-full max-w-[1840px] mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="border-b border-stone-200 pb-6">
          <nav className="text-xs text-stone-500 flex items-center gap-1.5 mb-2">
            ...
            <span>/</span>
            <Link href="/kategori/tum-urunler" className="hover:text-[#e60012] transition">Kategoriler</Link>
            {currentCategory && (
              <>
                <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
          ...
          <aside className={`lg:block ${isMobileFilterOpen ? 'fixed inset-0 z-50 bg-white p-6 overflow-y-auto' : 'hidden'} space-y-6 lg:bg-white lg:p-6 lg:rounded-2xl lg:border lg:border-stone-200`}>
            ...
            {/* Categories List */}
            <div>
              <h3 className="text-xs font-bold uppercase tracking-wider text-stone-900 mb-3 border-l-2 border-[#e60012] pl-2">
                Kategoriler
              </h3>
                ...
                <li>
                  <Link
                    ...
                    className={`block py-1.5 px-3 rounded-lg transition ${
                      !currentCategory ? 'bg-red-50 text-[#e60012] font-bold' : 'text-stone-600 hover:bg-stone-50'
                    }`}
                  >
                    ...
                    <li key={c.id}>
                      <Link
                        ...
                        className={`flex items-center justify-between py-1.5 px-3 rounded-lg transition ${
                          active ? 'bg-red-50 text-[#e60012] font-bold' : 'text-stone-600 hover:bg-stone-50'
                        }`}
                      >
                        <span>{c.name}</span>
            ...
            {/* Search Filter */}
            <div>
              <h3 className="text-xs font-bold uppercase tracking-wider text-stone-900 mb-2 border-l-2 border-[#e60012] pl-2">
                Koleksiyonda Ara
              </h3>
              <div className="relative">
                <input
                  ...
                  className="w-full text-xs py-2 pl-8 pr-3 bg-stone-50 border border-stone-200 rounded-lg focus:outline-none focus:border-[#e60012]"
                />
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-xs font-bold uppercase tracking-wider text-stone-900 border-l-2 border-[#e60012] pl-2">
                  Maksimum Fiyat
                </h3>
            ...
            {isMobileFilterOpen && (
              <button
                ...
                className="w-full py-3 bg-[#e60012] hover:bg-[#c90010] text-white font-bold text-xs rounded-xl mt-4 transition"
              >
            ...
            <div className="bg-white p-4 rounded-xl border border-stone-200 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                <select
                  ...
                  className="text-xs bg-stone-50 border border-stone-200 rounded-lg px-3 py-2 text-stone-800 font-medium focus:outline-none focus:border-[#e60012]"
                >
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-2xl border border-stone-200 p-12 text-center">
                ...
                <button
                  ...
                  className="mt-4 px-4 py-2 bg-[#e60012] hover:bg-[#c90010] text-white text-xs font-bold rounded-lg transition"
                >
                  Filtreleri Temizle
                </button>
              </div>
