        ...
        <div className="bg-white p-5 sm:p-8 rounded-3xl border border-stone-200 shadow-2xs space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full text-base sm:text-xs p-3 pl-10 bg-stone-50 border border-stone-300 rounded-xl focus:bg-white focus:outline-none focus:border-[#e60012] text-stone-900 transition"
                />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full text-base sm:text-xs p-3 pl-10 pr-10 bg-stone-50 border border-stone-300 rounded-xl focus:bg-white focus:outline-none focus:border-[#e60012] text-stone-900 transition"
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-[#e60012] hover:bg-[#c90010] active:scale-95 text-white font-bold text-xs sm:text-sm rounded-xl shadow-md transition flex items-center justify-center min-h-[48px] disabled:opacity-50 cursor-pointer"
            >
          ...
          <div className="pt-2 text-center text-xs text-stone-500">
            ...
            <Link href="/giris" className="text-[#e60012] font-bold hover:underline">
              Giriş Yapın
            </Link>
          </div>
