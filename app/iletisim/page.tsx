    ...
    <div className="bg-white min-h-screen">
      <div className="w-full max-w-[1840px] mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-12 space-y-8 sm:space-y-12 pb-24 lg:pb-12">
        ...
        <div className="text-center space-y-2">
          <span className="text-[11px] sm:text-xs font-bold uppercase tracking-widest text-[#e60012] bg-red-50 px-3 py-1 rounded-full border border-red-200 inline-block">
            Kurumsal İletişim
          </span>
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-white p-5 sm:p-6 rounded-3xl border border-stone-200 shadow-2xs space-y-4 text-xs">
              ...
              <div className="flex items-start gap-3">
                <div className="p-2.5 rounded-xl bg-red-50 text-[#e60012] border border-red-100 shrink-0">
                ...
                <div>
                  ...
                  <span className="text-[11px] text-[#e60012] font-semibold mt-0.5 block">
                    Fatih / İSTANBUL
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 border-t border-stone-100 pt-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div>
                    <a href="tel:+905077737777" className="text-stone-700 hover:text-[#e60012] font-bold block py-0.5 text-sm">
                      +90 (507) 773 77 77
                    </a>
                  </div>
                  <div>
              ...
              <div className="flex items-start gap-3 border-t border-stone-100 pt-4">
                ...
                <div>
                  ...
                  <a href="mailto:aylindurmus54@gmail.com" className="text-stone-700 hover:text-[#e60012] font-semibold block mt-1 text-xs">
              ...
              {isSent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-3.5 bg-[#e60012] hover:bg-[#c90010] active:scale-95 text-white font-bold text-xs rounded-xl shadow-md transition flex items-center justify-center gap-2 min-h-[44px] cursor-pointer"
                  >
            ...
            <div className="bg-white rounded-3xl border border-stone-200 overflow-hidden shadow-2xs">
              <div className="p-4 border-b border-stone-100 flex items-center justify-between">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[11px] text-[#e60012] hover:underline font-bold"
                >
                  Haritada Aç ↗
                </a>
              </div>
