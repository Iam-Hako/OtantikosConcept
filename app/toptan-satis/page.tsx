...
import { Sparkles, Building2, Phone, Mail, CheckCircle2, ShieldCheck } from 'lucide-react';
...
export default function WholesalePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      {isSubmitted ? (
        <div className="bg-emerald-50 border border-emerald-200 rounded-3xl p-10 text-center space-y-4 max-w-lg mx-auto">
        ...
        <div className="bg-white rounded-3xl border border-stone-200 p-6 sm:p-10 shadow-sm max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-4">
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold text-stone-700 mb-1">Firma / Mağaza Adı *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-stone-700 mb-1">Yetkili Adı Soyadı *</label>
                <input
                  type="text"
                  required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold text-stone-700 mb-1">Bulunduğunuz Şehir *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-stone-700 mb-1">Tahmini Aylık Alım Adedi</label>
                <select
            ...
            <div>
              <label className="block text-xs font-bold text-stone-700 mb-1">İlgilendiğiniz Ürün Grupları ve Notlarınız *</label>
              <textarea
                required
                rows={3}
            ...
            <button
              type="submit"
              className="w-full py-4 bg-amber-600 hover:bg-amber-700 text-white text-xs sm:text-sm font-bold rounded-xl shadow-lg transition"
            >
