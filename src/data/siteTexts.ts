...
export const DEFAULT_SITE_TEXTS: SiteTexts = {
  ...
  hero: {
    badge: "Bijuteri & Hediyelik Eşya",
    title: "Bijuteri &",
    highlightTitle: "Hediyelik Eşya",
    description: "Özgün bijuteri takı tasarımları, şık aksesuarlar ve en popüler hediyelik eşyalar.",
    buttonText: "Koleksiyonu Keşfet",
    adminButtonText: "Metinleri Düzenle",
    cardBadgeTitle: "OtantikosConcept",
    cardBadgeSub: "Bijuteri & Hediyelik Eşya",
    cardBadgeDesc: "Bijuteri ve hediyelik eşya koleksiyonu.",
  },
  categoriesSection: {
    badge: "Kategoriler",
    title: "Öne Çıkan Ürün Grupları",
    subtitle: "Bijuteri, hediyelik eşya ve trend oyuncak kategorilerimiz.",
    inspectButton: "Ürünleri İncele",
  },
  productsSection: {
    badge: "Yeni Eklenenler",
    title: "Yeni Ürünler",
    seeAllLink: "Tümünü Gör",
    subtitle: "Yeni gelen popüler ürünlerimiz",
  ...
  catalogPage: {
    ...
    subtitle: "Bijuteri, hediyelik eşya ve trend oyuncaklarımızı keşfedin.",
  ...
  accountPage: {
    ...
    registerSub: "Giriş yapmak ve sipariş vermek için hesap oluşturun.",
    loginTab: "Giriş Yap",
  ...
  brandStory: {
    ...
    content: "OtantikosConcept olarak en şık bijuteri ve hediyelik eşya modellerini sizlerle buluşturuyoruz.",
  },
  footer: {
    ...
    brandDescription: "OtantikosConcept - Bijuteri ve Hediyelik Eşya Mağazası.",
