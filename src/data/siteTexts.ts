...
export const DEFAULT_SITE_TEXTS: SiteTexts = {
  header: {
    ...
    topbarShipping: "Hızlı & Özenli Teslimat",
    topbarOriginal: "%100 Orijinal Ürünler",
    ...
    adminButton: "Site Yönetimi & Admin",
    accountLabel: "Hesabım",
    cartLabel: "Sepetim",
  },
  hero: {
    badge: "✨ Bijuteri & Trend Squishy Dünyası",
    ...
    cardBadgeSub: "Specialist Local & Trend Products",
    cardBadgeDesc: "NeeDoh Squishy Çin Mantısı, stres oyuncakları ve trend bijuteri takı tasarımları.",
  },
  categoriesSection: {
  ...
  productDetailPage: {
    ...
    badgeFastShipping: "Özenli & Hızlı Kargo",
    badgeOriginal: "%100 Orijinal Ürün Garantisi",
    badgeEasyReturn: "14 Gün İade Garantisi",
  ...
  cartPage: {
    ...
    couponPlaceholder: "Kupon Kodunuz (Örn: OTANTIK10)",
    couponApplyButton: "Uygula",
    couponSuccessText: "Kupon Kodu Uygulandı (%10 İndirim)",
    summaryTitle: "Sipariş Özeti",
    subtotal: "Ürün Toplamı",
    shipping: "Kargo Ücreti",
    couponDiscount: "Kupon İndirimi",
    total: "Ödenecek Toplam Tutarlar",
    checkoutButton: "Ödeme Yapmaya Geç",
    secureShoppingBadge: "Güvenli Alışveriş & 256-bit SSL Şifreleme Koruması",
  },
  checkoutPage: {
    ...
    fullNamePlaceholder: "Örn: Ayşe Yılmaz",
    ...
    cardOptionTitle: "Kredi / Banka Kartı (3D Secure)",
    cardOptionDesc: "Iyzico & SSL korumalı güvenli kartla ödeme yapın.",
    codOptionTitle: "Kapıda Ödeme (Nakit veya POS)",
  ...
  accountPage: {
    loginTitle: "OtantikosConcept'e Giriş",
    loginSub: "Siparişlerinizi takip etmek veya Admin Paneline girmek için giriş yapın.",
    registerTitle: "Yeni Hesap Oluştur",
    registerSub: "Trend oyuncak, squishy ve bijuteri fırsatlarından yararlanmak için kaydolun.",
    loginTab: "Giriş Yap",
    ...
    adminBadge: "Yönetici / Admin",
    customerBadge: "Müşteri",
    goToAdminButton: "Admin Paneline Git",
  ...
  footer: {
    ...
    trust2Desc: "256-Bit SSL Şifreleme",
    trust3Title: "Kolay İade",
    trust3Desc: "14 Gün İade Garantisi",
    trust4Title: "7/24 Destek",
    trust4Desc: "Samimi Müşteri Hizmetleri",
    ...
    paymentMethodsBadge: "💳 Visa / Mastercard / Troy / Iyzico / Stripe Uyumlu",
