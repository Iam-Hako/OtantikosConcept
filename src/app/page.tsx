...
import { ArrowRight, Sparkles, Plus, ShieldCheck } from "lucide-react";
import ProductCard from "@/components/ProductCard";
import { useAuth } from "@/context/AuthContext";

export default function HomePage() {
  const { settings, products, isAdmin } = useAuth();
    ...
    <div className="space-y-16 pb-16">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#EAE0D5] to-[#F8F5F0] py-16 md:py-24 border-b border-[#E6DCD3]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            {/* Sol Taraf: Marka Sloganı & CTA (Admin Panelinden Düzenlenebilir) */}
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#C86D51]/10 border border-[#C86D51]/30 text-[#C86D51] text-xs font-semibold uppercase tracking-wider">
                ...
                <span>Bijuteri & Trend Squishy Dünyası</span>
              </div>

              <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold text-[#3E2E28] leading-[1.15]">
                {settings.heroTitle} <br />
                <span className="text-[#C86D51] italic font-normal">{settings.heroHighlightText}</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                ...
                {isAdmin && (
                  ...
                  >
                    ...
                    <span>Metinleri Düzenle & Ürün Ekle</span>
                  </Link>
                )}
              </div>
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative w-80 h-96 sm:w-96 sm:h-[450px] rounded-3xl overflow-hidden shadow-2xl border-4 border-white flex flex-col items-center justify-center bg-[#EAE0D5] p-8 text-center">
                ...
                <p className="text-xs text-[#7C6354] mt-4 max-w-xs">NeeDoh Squishy Çin Mantısı, stres oyuncakları ve trend bijuteri takı tasarımları.</p>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl font-bold text-[#3E2E28] mt-1">Öne Çıkan Ürün Grupları</h2>
          <p className="text-sm text-[#7C6354] mt-2">NeeDoh Squishy Çin Mantısı ve göz alıcı bijuteri takılarımız.</p>
        </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-8">
            <div>
              ...
              <h2 className="font-serif text-3xl font-bold text-[#3E2E28]">Yeni Ürünler</h2>
            </div>
